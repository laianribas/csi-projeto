...
import { ControllerChamadoPorSetor } from "../controllers/Chamado/Controller_Chamado_Por_Setor";
...
const controllerChamadoPorSetor = new ControllerChamadoPorSetor()
...
RotasChamado.get('/setor', verificarToken, controllerChamadoPorSetor.handle)
